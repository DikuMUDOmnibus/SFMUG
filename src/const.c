...
"Staff", "Slug thrower", "Blaster", "Shock Lance"
};

char *	projectiles		[PROJ_MAX] =
{
"Bolt", "Arrow", "Dart", "Stone", "Bullet", "Energy", "Energy"
};
...
char * s_blast_messages[24] =
{
	"miss", "brush", "scratch", "graze", "nick", "jolt", "wound",
	"injure", "hit", "burn", "scorch", "maul", "decimate", "_traumatize_",
	"_devastate_", "_maim_", "_demolish_", "MUTILATE", "MASSACRE",
	"PULVERIZE", "DESTROY", "* OBLITERATE *", "*** ANNIHILATE ***",
	"**** SMITE ****"
};

char * p_blast_messages[24] =
{
	"misses", "brushes", "scratches", "grazes", "nicks", "jolts", "wounds",
	"injures", "hits", "burns", "scorches", "mauls", "decimates", "_traumatizes_",
	"_devastates_", "_maims_", "_demolishes_", "MUTILATES", "MASSACRES",
	"PULVERIZES", "DESTROYS", "* OBLITERATES *", "*** ANNIHILATES ***",
	"**** SMITES ****"
};
char ** const s_message_table[DAM_MAX_TYPE] =
{
        ...
        s_slug_messages,        /* bullet */        
        s_blast_messages,       /* blast */
        s_blast_messages,       /* shock lance */
};
...
char ** const p_message_table[DAM_MAX_TYPE] =
{
        ...
        p_slug_messages,        /* bullet */
        p_blast_messages,       /* blast */
        p_blast_messages,       /* shock lance */
};
