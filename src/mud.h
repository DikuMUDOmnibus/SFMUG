 ...
 */
#define CODEBASE_VERSION_TITLE	"SFMUG"
#define CODEBASE_VERSION_MAJOR	"0"
#define CODEBASE_VERSION_MINOR	"03"
#define CODEBASE_VERSION_INFO	"This is a pre-relase ofthe SFMUG code base. This release is not intended for production useage. This release contains numerous bug fixes from the public beta. It also contains a few changes 'under the hood' so to speak.\n\r\tI hope you enjoy this work. Also, please, FOLLOW THE LICENSE!"
...
typedef enum
{
  QTIMER_NEXT, QTIMER_CURR, MAX_QTIMER
} quest_timers;
...
#define CLASS_SOLDIER       9
#define CLASS_PILOT        10
#define CLASS_HACKER       11
...
#define LANG_UNCOMMON    BV23  /* Undercommon, not quite... good enough for common */
...
typedef enum {SHIP_DOCKED, SHIP_READY, SHIP_BUSY, SHIP_BUSY_2, SHIP_BUSY_3, SHIP_REFUEL,
              ...
              SHIP_DESTROYED, SHIP_LOST } ship_states;
typedef enum {MISSILE_READY, MISSILE_FIRED, MISSILE_RELOAD, MISSILE_RELOAD_2, MISSILE_DAMAGED} missile_states;
typedef enum {SPACECRAFT, CAPITAL_SHIP, SPACE_STATION, AIRCRAFT, BOAT, SUBMARINE, LAND_VEHICLE } ship_classes;
...
struct  planet_data
{
    ...
    int 	     population;
    int		     tec_level;     /* Technoly Level -Lews 1/03 */
    float            pop_support;
    int		     sector;
    int 	     x, y, z;
    int              size;
...
typedef enum
{
  ...
  CLAN_THIEF, CLAN_CLERIC, CLAN_PILOT, CLAN_UNDEAD, CLAN_CHAOTIC, CLAN_NEUTRAL, CLAN_LAWFUL,
...
struct ship_data
{
    ...
    ROOM_INDEX_DATA *docked; /* ship is docked in this virtual ship room */
    SPACE_DATA * starsystem;
    TURRET_DATA *first_turret;
    TURRET_DATA *last_turret;
    HANGER_DATA *first_hanger; /* not used yet */
    HANGER_DATA *last_hanger; /* not used yet */
    ROOM_INDEX_DATA *hanger; /* ship hanger */
    char *      filename;
    char *      name;
    char *      home;
    ...
    int         lastdoc;
    int         shipyard;
    char *      on_ship; /* ship docked on this ship */
    long        collision;
    SHIP_DATA  *target;
    SPACE_DATA *currjump;
    sh_int      chaff;
...
#define MOB_VNUM_SOLDIER		300
#define MOB_VNUM_GUARD			301
#define MOB_VNUM_PATROL			302
#define MOB_VNUM_TRADER			303
#define MOB_VNUM_SPACEPORT_GUARD	304
#define MOB_VNUM_BIRD			305
#define MOB_VNUM_SCAVENGER		306
#define MOB_VNUM_INSECT			307
#define MOB_VNUM_PREDITOR		308
#define MOB_VNUM_SMALL_ANIMAL		309
#define MOB_VNUM_FISH			310
#define MOB_VNUM_CITIZEN		311
#define MOB_VNUM_SUPPLIER 		312
#define MOB_VNUM_WAITER 		313
#define MOB_VNUM_CONTROLLER		314
#define MOB_VNUM_BARTENDER		315
#define MOB_VNUM_MECHANIC		316
#define MOB_VNUM_PAWNER			317
#define MOB_VNUM_TECHNICIAN		318
#define MOB_VNUM_DEALER			319
#define MOB_VNUM_VENDOR			320
#define MOB_VNUM_DRAGON			321
#define MOB_VNUM_THIEF			322
#define MOB_VNUM_THUG			323
#define MOB_VNUM_BUM			324
#define MOB_VNUM_SHIP_GUARD		325
#define MOB_VNUM_ALIEN			326
#define MOB_VNUM_JOB_OFFICER		327
#define MOB_VNUM_MEDIC  		328

#define MOB_VNUM_FIRST_RANDOM_MOB	300
#define MOB_VNUM_LAST_RANDOM_MOB  	328  /* make sure to increase this for random mob check problems */
...
#define RIS_SLUG		  BV24
#define RIS_BLAST		  BV25
#define RIS_SLANCE		  BV26
/* 25 RIS's*/
...
#define OBJ_VNUM_SCHOOL_GUIDE     10333

/* from SWR */
#define OBJ_VNUM_DROID_CORPSE        303


#define OBJ_VNUM_LIGHT		     304


#define OBJ_VNUM_PROTO_LIGHTSABER    306
#define OBJ_VNUM_MESSAGE_TERMINAL    307

#define OBJ_VNUM_MAIL_TERMINAL       310
#define OBJ_VNUM_BLASTER             311
#define OBJ_VNUM_CANTEEN             313
#define OBJ_VNUM_BACKPACK            314
#define OBJ_VNUM_PROTO_BLASTER	     315
#define OBJ_VNUM_PROTO_BLADE	     316
#define OBJ_VNUM_COMLINK             317
#define OBJ_VNUM_PROTO_ARMOR	     318
#define OBJ_VNUM_IMM_TERMINAL	     319
#define OBJ_VNUM_PROTO_SHIELD	     320
#define OBJ_VNUM_DRIED_FRUIT	     321
#define OBJ_VNUM_AMMO                322
#define OBJ_VNUM_FIRST_PART	     323  /* first randomly placed object */
#define OBJ_VNUM_LAST_PART	     331  /* last randomly placed object */

#define OBJ_VNUM_FRUIT		     344
#define OBJ_VNUM_ROOT		     345
#define OBJ_VNUM_SEAWEED	     346
#define OBJ_VNUM_PLANT		     347
#define OBJ_VNUM_HEMP		     348
#define OBJ_VNUM_RESIN		     349
#define OBJ_VNUM_CRYSTAL	     350
#define OBJ_VNUM_METAL		     351
#define OBJ_VNUM_GOLD		     352
#define OBJ_VNUM_SHOVEL		     353
#define OBJ_VNUM_BATTERY             354
#define OBJ_VNUM_APPETIZER           355
#define OBJ_VNUM_SALAD               356
#define OBJ_VNUM_LUNCH               357
#define OBJ_VNUM_DINNER              358
#define OBJ_VNUM_GLASSOFWATER        359
#define OBJ_VNUM_COFFEE              360
#define OBJ_VNUM_JUICE               361
#define OBJ_VNUM_BEER                362
#define OBJ_VNUM_WHISKEY             363
#define OBJ_VNUM_DRAGON_CRYSTAL      364
#define OBJ_VNUM_DRAGON_NEST         365
#define OBJ_VNUM_SEWKIT              366

#define OBJ_VNUM_FIRST_FABRIC        367  
#define OBJ_VNUM_LAST_FABRIC         391

#define OBJ_VNUM_PACKAGE             392
#define OBJ_VNUM_MEDPAC              393  /* need to make a medpac -Lews */
#define OBJ_VNUM_CLUB                394
#define OBJ_VNUM_SHSWORD             395  
#define OBJ_VNUM_MACE                396  /* peper spray, not the medevil weapon -Lews */
#define OBJ_VNUM_WALKMAN             397
#define OBJ_VNUM_GAMEBOY             398
...
typedef enum
{
  ...
  ITEM_LOOTABLE,	ITEM_PKDISARMED,	ITEM_ANTI_PILOT,
  ITEM_RARE,		ITEM_UNIQUE,
  MAX_ITEM_FLAG
} item_extra_flags;
...
#define ROOM_LIMBO_SHIPYARD        1202
#define ROOM_NEWBIE_SHIPYARD       1202
...
typedef enum
{
  ...
  SECT_SCRUB, SECT_ROCKY, SECT_SAVANNA, SECT_TUNDRA, SECT_GLACIAL, 
  SECT_RAINFOREST, SECT_JUNGLE, SECT_WETLANDS, SECT_BRUSH, SECT_STEPPE, 
  SECT_FARMLAND, SECT_VOLCANIC,
  SECT_MAX
} sector_types;
...
typedef enum
{
  ...
  PLR_ANSI,	PLR_RIP,	PLR_NICE,	PLR_FLEE,	PLR_AUTOGOLD,
...
#define CHANNEL_SHIP               BV28
#define CHANNEL_SYSTEM             BV29
#define CHANNEL_GNET               BV30
...
struct	pc_data
{
    ...
    int			quest_timer[MAX_QTIMER]; /* Orion Elder */
...
typedef enum
{
   ...
   DAM_PIERCE, DAM_THRUST, DAM_SLUG, DAM_BLAST, DAM_SLANCE,
   DAM_MAX_TYPE
} damage_types;
...
typedef enum
{
  ...
  WEP_SLUG, WEP_BLASTER, WEP_SLANCE,
  WEP_MAX
} weapon_types;
...
typedef enum
{
  PROJ_BOLT, PROJ_ARROW, PROJ_DART, PROJ_STONE, PROJ_BULLET, PROJ_BLAST,
  PROJ_SLANCE, PROJ_MAX
} projectile_types;
...
extern  sh_int  gsn_slugs;
extern  sh_int  gsn_blasters;
extern  sh_int  gsn_slances;
...
#define CAN_CAST(ch)		((ch)->class != CLASS_THIEF && (ch)->class != CLASS_WARRIOR && (ch)->class != CLASS_PILOT)
...
ED *	get_ship_exit	args( ( ROOM_INDEX_DATA *room, sh_int dir ) );
ED *	get_exit_to	args( ( ROOM_INDEX_DATA *room, sh_int dir, int vnum ) );
ED *	get_ship_exit_to  args( ( ROOM_INDEX_DATA *room, sh_int dir ) );
...
RID        *  get_ship_hanger 		    args( ( char *name ) );
...
bool         ship_to_hanger         args( ( SHIP_DATA *ship , ROOM_INDEX_DATA *shipto ) );
