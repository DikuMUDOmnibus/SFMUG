...
const	struct	model_type	model	[MAX_SHIP_MODEL+1] =
{
  /*  name, hyperspeed, realspeed, missiles, lasers, tractorbeam, manuever, energy, shield, hull, rooms */
    { "Short Range Fighter",      0, 255,   5,   2,  0, 255,   2500,   50,   250,   1 },  /* FIGHTER1  */
    { "Shuttle", 		150, 200,   0,   1,  0, 100,   2500,   50,   250,   2 },  /* SHUTTLE1  */
    { "Transport", 		100, 100,   0,   2,  0,  75,   3500,  100,  1000,  4 },  /* TRANSPORT1  */
    { "Long Range Fighter", 	100, 150,   8,   3,  0, 150,   3500,  100,  500,   1 },  /* FIGHTER2  */
    ...
    { "Cruiser", 	        200,  50,  70,   8,  0,  50,  20000,  500,  20000, 15 },  /* CRUISER  */
    { "Battlecruiser", 		200,  35,  100, 10,  0,  35,  30000,  750,  25000, 18 },  /* BATTLESHIP  */
    { "Flagship", 		250,  25,  150, 10,  0,  25,  35000, 1000, 30000, 24 },  /* FLAGSHIP  */
    { "Station1", 		  0,   0,   20,  4,  1,   0,  10000,  500,  5000, 41 },  /* STATION1  */
    { "Station2", 		  0,   0,   80,  6,  1,   0,  20000,  800,  8000, 24 },  /* STATION2  */
    { "Station3", 		  0,   0,  150,  8,  1,   0,  30000, 1000, 10000, 24 },  /* STATION3  */
...
void 	post_medic( ROOM_INDEX_DATA * pRoomIndex );
...
{   
    ...
    ch_printf( ch, "%s : %s\n\rFilename: %s\n\r",
		       ...
		       (prototype->class == CAPITAL_SHIP ? model[prototype->model].name : 
...
void create_ship_rooms( SHIP_DATA * ship )
{
    ...
    case CRUISER:
         ...
         post_ship_guard( room[1] );
         post_ship_guard( room[1] );
         post_ship_guard( room[9] );
         post_ship_guard( room[9] );
         post_ship_guard( room[10] );
         post_medic( room[4] );
         break;
    ...
    case FLAGSHIP:
         ...
         make_lounge( room[21], ship );
         make_hanger( room[8], ship );
         /* used to be a hanger */
         make_lounge( room[14], ship );
         ...
         case STATION1:
         make_copilot( room[40], ship );
         make_bridge(  room[39], ship );
         make_turret( room[37], ship );
         make_turret( room[36], ship );
         make_turret( room[35], ship );
         make_turret( room[34], ship );
         make_lounge( room[32], ship );
         make_medical( room[31], ship );
         make_hanger( room[13], ship );
         make_turret( room[4], ship );
         make_turret( room[3], ship );
         make_turret( room[2], ship );
         make_turret( room[1], ship );
         bridge_rooms( room[0] , room[1] , DIR_NORTHEAST );  /* level 1 */
         bridge_rooms( room[0] , room[2] , DIR_SOUTHEAST );
         bridge_rooms( room[0] , room[3] , DIR_SOUTHWEST );
         bridge_rooms( room[0] , room[4] , DIR_NORTHWEST );
         bridge_rooms( room[5] , room[6] , DIR_EAST );       /* level 2 */
         bridge_rooms( room[6] , room[7] , DIR_EAST );
         bridge_rooms( room[5] , room[8] , DIR_SOUTH );
         bridge_rooms( room[5] , room[9] , DIR_SOUTH );
         bridge_rooms( room[5] , room[10] , DIR_WEST );
         bridge_rooms( room[5] , room[11] , DIR_WEST );
         bridge_rooms( room[5] , room[12] , DIR_NORTH );
         bridge_rooms( room[5] , room[13] , DIR_NORTH );
         bridge_rooms( room[14] , room[15] , DIR_EAST );      /* level 3 */
         bridge_rooms( room[14] , room[16] , DIR_SOUTH );
         bridge_rooms( room[14] , room[17] , DIR_WEST );
         bridge_rooms( room[14] , room[18] , DIR_NORTH );
         bridge_rooms( room[18] , room[19] , DIR_NORTH );
         bridge_rooms( room[19] , room[20] , DIR_SOUTHEAST );
         bridge_rooms( room[20] , room[21] , DIR_SOUTHEAST );
         bridge_rooms( room[21] , room[22] , DIR_SOUTHEAST );
         bridge_rooms( room[22] , room[23] , DIR_SOUTHWEST );
         bridge_rooms( room[23] , room[24] , DIR_SOUTHWEST );
         bridge_rooms( room[24] , room[25] , DIR_SOUTHWEST );
         bridge_rooms( room[25] , room[26] , DIR_NORTHWEST );
         bridge_rooms( room[26] , room[27] , DIR_NORTHWEST );
         bridge_rooms( room[27] , room[28] , DIR_NORTHWEST );
         bridge_rooms( room[28] , room[29] , DIR_NORTHEAST );
         bridge_rooms( room[29] , room[30] , DIR_NORTHEAST );
         bridge_rooms( room[30] , room[19] , DIR_NORTHEAST );
         bridge_rooms( room[22] , room[31] , DIR_EAST );
         bridge_rooms( room[25] , room[32] , DIR_SOUTH );
         bridge_rooms( room[33] , room[34] , DIR_NORTHEAST );  /* level 4 */
         bridge_rooms( room[33] , room[35] , DIR_SOUTHEAST );
         bridge_rooms( room[33] , room[36] , DIR_SOUTHWEST );
         bridge_rooms( room[33] , room[37] , DIR_NORTHWEST );
         bridge_rooms( room[38] , room[39] , DIR_NORTH );      /* level 5 */
         bridge_rooms( room[39] , room[40] , DIR_EAST );
         bridge_rooms( room[0] , room[5] , DIR_UP  );      /* Conect Levels */
         bridge_rooms( room[5] , room[14] , DIR_UP ); 
         bridge_rooms( room[14] , room[33] , DIR_UP  );
         bridge_rooms( room[33] , room[38] , DIR_UP  );
         post_ship_guard( room[7] );                         /* Crew mobs */
         post_ship_guard( room[7] );
         post_ship_guard( room[9] );
         post_ship_guard( room[9] );
         post_ship_guard( room[11] );
         post_ship_guard( room[11] );
         post_ship_guard( room[13] );
         post_ship_guard( room[13] );
         post_ship_guard( room[39] );
         post_ship_guard( room[39] );
         post_medic( room[31] );
         break;
...
void    make_medical( ROOM_INDEX_DATA *room , SHIP_DATA *ship )
{
     ...
     strcpy( buf , "\n\r" );
     strcat( buf , "The air feels very clean here. insturments lay on tables, and near the\n\r" );
     strcat( buf , "large examination table. This is where the ship surgen is usually on staff\n\r" );
     strcat( buf , "\n\r" );
     STRFREE ( room->description );
     room->description = STRALLOC(buf);
}
...
void    make_entrance( ROOM_INDEX_DATA *room , SHIP_DATA *ship )
{
     ...
     strcpy( buf , "\n\r" );
     strcat( buf , "This is the entrance ramp, type leave to exit the ship.\n\r" );
     strcat( buf , "\n\r" );
     STRFREE ( room->description );
     room->description = STRALLOC(buf);
}
...
void    make_hanger( ROOM_INDEX_DATA *room , SHIP_DATA *ship )
{
     ...
     STRFREE( room->name );
     room->name = STRALLOC( ship->name );

     strcpy( buf , "\n\r" );
     strcat( buf , "This large area is for incomming ships. containers of supplies are\n\r" );
     strcat( buf , "stacked and straped in on the sides.\n\r" );
     strcat( buf , "\n\r" );
     STRFREE ( room->description );
     room->description = STRALLOC(buf);
}

/* We'll use this later -Lews 1/01
void    make_hanger( ROOM_INDEX_DATA *room , SHIP_DATA *ship )
{
     char buf[MAX_STRING_LENGTH];
     HANGER_DATA *hanger;
     ...
     strcpy( buf , "\n\r" );
     strcat( buf , "This is where ships park\n\r" );
     strcat( buf , "\n\r" );
     STRFREE ( room->description );
     room->description = STRALLOC(buf);

     CREATE( hanger, HANGER_DATA, 1 );
     hanger->next = NULL;
     hanger->prev = NULL;
     hanger->room = room;
     hanger->bayopen =1;

     LINK( hanger, ship->first_hanger, ship->last_hanger, next, prev );
}
*/
...
void    make_garage( ROOM_INDEX_DATA *room , SHIP_DATA *ship )
{
     ...
     strcpy( buf , "\n\r" );
     strcat( buf , "This is where land and atmosperic vehicles can be stored.\n\r" );
     strcat( buf , "\n\r" );
     STRFREE ( room->description );
     room->description = STRALLOC(buf);
}
...
void post_medic( ROOM_INDEX_DATA * pRoomIndex )
{
	    ...
	    OBJ_DATA *medpac;
            ...
            if ( !(pMobIndex = get_mob_index(MOB_VNUM_MEDIC)) )
            {
            ...
            if ( ( pObjIndex = get_obj_index( OBJ_VNUM_MEDPAC ) ) != NULL )
            {
                 medpac = create_object( pObjIndex, mob->level );
                 obj_to_char( medpac, mob );                        
            }
            if ( room_is_dark(pRoomIndex) )
                   xSET_BIT(mob->affected_by, AFF_INFRARED);

            sprintf( tmpbuf , "A medic is here to heal your wounds.\n\r" );
