...
char *	const	r_flags	[] =
{
"dark", "death", "nomob", "indoors", "canland", "garage", "control", "nomagic", "tunnel",
"private", "safe", "solitary", "petshop", "norecall", "donation", "barraks", "silence",
"logspeech", "nodrop", "clanstoreroom", "nosummon", "noastral", "teleport", "teleshowdesc",
"nofloor", "nosupplicate", "arena", "nomissile", "shipyard", "spacecraft", "prototype",
"dnd"
};
...
"nolocate", "groundrot", "lootable", "pkdisarmed", "antipilot" };
...
void do_goto( CHAR_DATA *ch, char *argument )
{
    ...
    ROOM_INDEX_DATA *location, *in_room, *fromroom, *toroom;
	...
	/* Board a ship -Lews 2/2002 */
	if ( ( ship = get_ship( arg ) ) != NULL )
	{
   		fromroom = ch->in_room;

		if ( ( ( toroom = ship->entrance )  != NULL ) || ( ( toroom = ship->hanger )  != NULL ) )
		{
			act( AT_PLAIN, "$n steps though a glowing portal $T.", ch,
...
void do_aset( CHAR_DATA *ch, char *argument )
{
	...
	send_to_char( "  author derivatives resetmsg resetfreq flags teclevel\n\r", ch );
